...
{{--                            <img src="{{ asset('assets/backend/assets/images/logo-dark.png') }}" height="30" class="logo-dark mx-auto" alt="">--}}
{{--                            <img src="{{ asset('assets/backend/assets/images/logo-light.png') }}" height="30" class="logo-light mx-auto" alt="">--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--                </div>--}}
