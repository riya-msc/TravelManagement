                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.destination.update',$destination->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control" name="number_of_cities" value="{{ $destination->number_of_cities }}">
                                    ...
                                    <div class="col-6">
                                        <img src="{{ asset($destination->thumb) }}" style="height: 100px" id="showImage">
                                    </div>
                                </div>
